...
(function ($) {
  ...
  var polyv = window.polyv = {
    ...
    fingerprint: function(file) {
      return 'polyv-' + file.name + '-' + file.type + '-' + file.size;
    }
  };
  ...
  ResumableUpload.prototype._post = function() {
    ...
    var options = {
	  ...
	  data: {title:self.options.title,ext:self.options.ext,desc:self.options.desc},
      headers: {
  ...
  ResumableUpload.prototype._urlCache = function(url) {
    ...
    if (fingerPrint === undefined) {
      fingerPrint = polyv.fingerprint(this.file);
    }
